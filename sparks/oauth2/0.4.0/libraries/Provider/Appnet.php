...
class OAuth2_Provider_Appnet extends OAuth2_Provider {
	...
	{
		//echo ("url_authorize");
		return 'http://alpha.app.net/oauth/authenticate';
	}

	public function url_access_token()
	{
		//return 'http://alpha.app.net/oauth/access_token';
		$this->method = "POST";
	...
	{	
		$url = 'http://alpha-api.app.net/stream/0/users/me?'.http_build_query(array(
